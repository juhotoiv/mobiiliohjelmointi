...
export default function App() {
  ...
  const fetchRestaurants = () => {
    fetch('https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=' + lat + ',' + lng + '&radius=300&type=restaurant&key=AIzaSyBEzGG2lzNO193XVs5_0b-Tsj-F0Soll9s')
        .then(response => response.json())
